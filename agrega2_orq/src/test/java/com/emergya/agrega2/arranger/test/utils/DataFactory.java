...
public class DataFactory {
    ...
    private static String[] nombres = { "Jin", "Jacqueline", "Kendall", "Daquan", "Kiara", "Pandora", "Kirestin",
            "Carol", "Walter", "Adrienne", "Michael", "Chandler", "Jerry", "Ryder", "Burke", "Unity", "Diana",
            "Sybill", "Cullen", "Risa", "Walter", "Charde", "Kiara", "Nasim", "Caleb", "Anne", "Lucas", "Brock",
            "Echo", "Ashely", "Kirk", "Blair", "Hadassah", "Phyllis", "Clinton", "Haviva", "Amber", "Nicole", "Echo",
            "Zeph", "Chloe", "Quinn", "Leigh", "Amy", "Jillian", "Ishmael", "Lucian", "Katelyn", "Irene", "Grace",
            "Aretha", "Knox", "Montana", "Nero", "Lee", "Camilla", "Axel", "Jaden", "Sonia", "Donovan", "Elizabeth",
            "Ulric", "Alan", "Valentine", "Faith", "Sloane", "Daphne", "Brady", "April", "Ivor", "Belle", "Malachi",
            "Abbot", "Jessamine", "Raphael", "Zeus", "Piper", "Baker", "Ivory", "Olivia", "Chaney", "Dieter",
            "Veronica", "Shelby", "Lisandra", "Dante", "Dane", "Veda", "Rhea", "Kathleen", "Len", "Sasha", "Michael",
            "Barclay", "Yoko", "August", "Chadwick" };
    ...
    public static Date getRandomDate() {
        return new Date(Math.abs(System.currentTimeMillis() - RandomUtils.nextLong(0, 99999999)));
    }
}
