...
import com.emergya.agrega2.arranger.controller.recommender.RecomendarPost;
...
@Deprecated
@Component
public class RecomendarPostController implements RecomendarPost {

    private static final Log LOG = LogFactory.getLog(RecomendarPostController.class);

    public @ResponseBody
    List<Recomendacion> recomendarPOST(HttpServletRequest request) {
        try {
            ...
            final List<Recomendacion> lstRes = Decisor.recomendarContenido(idUser, idContent, TipoContenido.POST,
                    numRecomendaciones);
