...
public class ResourceTypeDump {

    private static final Log LOG = LogFactory.getLog(ResourceTypeDump.class);
    ...
    public static boolean updateRTODES(String param) {
        ...
        try {
            ...
            Utils.logInfo(LOG, "==============================================");
            Utils.logInfo(LOG, "RT DUMP process......");
            Utils.logInfo(LOG, "==============================================");
    ...
    private static void injectRTToOde(final SolrDocument doc) {
        ...
        String odeNodeStr = (String) doc.getFieldValue("odeNode");
        ...
        odeNodeStr = AgregaUtil.getNodoOde(mecId, odeLanguage);
    ...
    private static SolrDocumentList getSolrIds(String queryStr) {
        ...
        query.setFields("id", "mecIdentifierStr", "preview");
