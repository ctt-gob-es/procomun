  ...
  <div id="main-content">
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="primary" class="content-area col-sm-<?php print $content_col; ?> col-md-<?php print $content_col; ?> <?php print $aside_count; ?>">
          <section id="content" role="main" class="clearfix center">
            ...
            <div id="content-wrap">
              ...
              <?php if (isset($rss_link) && !empty($rss_link)): print $rss_link; endif; ?>
        ...
        <?php if ($page['sidebar_first']): ?>
          <aside id="sidebar-first" class="col-sm-3 col-md-3" role="complementary">
