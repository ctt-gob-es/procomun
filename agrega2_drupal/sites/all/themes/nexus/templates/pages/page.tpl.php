<?php if ($is_front): ?>
    <?php //$title = ''; // This is optional ... it removes the default Welcome to @site-name ?>
    <?php // This will remove the 'No front page content has been created yet.' ?>
      ...
      <div class="row">
        ...
        <div id="primary" class="content-area col-md-<?php print $content_col; ?> <?php print $aside_count; ?>">
          <section id="content" role="main" class="clearfix center">
            ...
            <div id="content-wrap">
              <?php if (isset($create_link) && !empty($create_link)): print $create_link; endif; ?>
              <?php if (!empty($tabs['#primary'])): ?><div class="tabs-wrapper clearfix"><?php print render($tabs); ?></div><?php endif; ?>
              <?php if (!empty($profile_view_button)): ?>
                <div class="<?php print $profile_view_class; ?>"><?php print $profile_view_button; ?></div>
              <?php endif; ?>
              ...
              <?php endif; ?>
              <?php if (isset($tab_title)):?>
                <h2 class="tab-title"><?php print $tab_title; ?></h2>
              <?php endif; ?>
        ...
        <?php if ($page['sidebar_first']): ?>
          <aside id="sidebar-first" class="col-md-3" role="complementary">
            <span class="facet-filters-title"><?php print t('Filter by'); ?></span>
