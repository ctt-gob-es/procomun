...
<div style="margin-top:0; min-height: 135px; text-align: right; background: url('https://procomun.educalab.es/sites/all/themes/nexus/logo.png') center 20px no-repeat #F7FAFA; color:#4C6172; margin-bottom: 0; border-top: 45px solid #283b4d" class="htmlmail-simplenews-link">
  <a style="display: inline-block; padding: 15px; color: #283B4D" href="<?php echo url('node/' . $params['simplenews_source']->getNode()->nid, array('absolute' => TRUE)); ?>">
