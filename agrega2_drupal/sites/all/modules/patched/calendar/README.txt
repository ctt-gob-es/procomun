...
=========================================================
 - File:
    calendar-illegal_string_offset_data-1591388-4.patch
 - Reason:
    The module shows warnings when the content pane is being rendered. This issue
    has been indicated by other users in drupal.org. The patch has been taken from
    https://www.drupal.org/node/1591388#comment-7715305