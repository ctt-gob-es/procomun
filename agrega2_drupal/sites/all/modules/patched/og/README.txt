...
1.- og_ui-show_message_confirmation-0.patch : Este parche permite que se vean los mensajes
    de confirmacion para solicitar una red social siempre.

2.- og-default-role-member-2005800-32.patch : Este parche permite añade permisos de administrador
    al creador de un grupo orgánico en aquellos grupos con permisos sobrescritos
