PATCHES
=======
1.- entityreference-2010898-80-Use-tokens.patch
    This patch include the ability to reference a entity by a given token in views.
    It is described in this URL:  https://www.drupal.org/node/2010898
