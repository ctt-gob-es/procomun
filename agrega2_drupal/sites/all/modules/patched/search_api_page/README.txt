...
Patch applied to this module: search_api_page_modificacion_template_search_api_page_results_tpl_php_para_renderizar_resultados.patch
-----------------------------------------------

The search_api_results.tpl.php has been modified to make a right rendering of the results acoording to ours needs, this modification 
will be rebuild with the next re-indexation of a future schema.xml.
