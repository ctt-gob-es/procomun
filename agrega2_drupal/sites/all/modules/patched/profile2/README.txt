...
Name: profile2_avoid_admin_all_profiles_same_time.patch
Description: Avoid access to all profiles for admin user. When we edit an organization i.e., we never have access to the personal data profile.